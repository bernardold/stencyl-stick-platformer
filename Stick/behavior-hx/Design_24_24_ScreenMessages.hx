...
class Design_24_24_ScreenMessages extends SceneScript
{
...
public var _gameOverMsg:String;

public var _winMsg:String;
...
_crouchMsg = "";
nameMap.set("gameOverMsg", "_gameOverMsg");
_gameOverMsg = "";
nameMap.set("winMsg", "_winMsg");
_winMsg = "";
...
propertyChanged("_crouchMsg", _crouchMsg);
        _gameOverMsg = "Game Over!!!";
propertyChanged("_gameOverMsg", _gameOverMsg);
        _winMsg = "You Win!!!";
propertyChanged("_winMsg", _winMsg);
...
{
            g.drawString("" + _gameOverMsg, ((getScreenWidth() / 2) - (g.font.font.getTextWidth(_gameOverMsg)/Engine.SCALE / 2)), 320);
}

        if(Engine.engine.getGameAttribute("WinGame"))
{
            g.drawString("" + _winMsg, ((getScreenWidth() / 4) - (g.font.font.getTextWidth(_winMsg)/Engine.SCALE / 2)), 80);
}
