...
{
        if((!(_barrierRemoved) && (Engine.engine.getGameAttribute("haveEraser") && ((Engine.engine.getGameAttribute("PlayerXPosition") >= 675) && (Engine.engine.getGameAttribute("PlayerXPosition") <= 690)))))
{
