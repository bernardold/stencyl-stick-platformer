...
{
        if((_barrierRemoved && (!(_bridgeCreated) && (Engine.engine.getGameAttribute("havePencil") && ((Engine.engine.getGameAttribute("PlayerXPosition") >= 585) && (Engine.engine.getGameAttribute("PlayerXPosition") <= 600))))))
{
...
if(wrapper.enabled && pressed)
{
        if((!(_barrierRemoved) && (Engine.engine.getGameAttribute("haveEraser") && ((Engine.engine.getGameAttribute("PlayerXPosition") >= 585) && (Engine.engine.getGameAttribute("PlayerXPosition") <= 615)))))
{
